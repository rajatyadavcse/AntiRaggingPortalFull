...
public class ComplainServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    Complain complain=new Complain(id,ComplainantName,victimName,email,mobileNumber,collegeName,yourAddress,pincode,state,dt,raggingDetails,photoProof,user.getUserDetail().getId());
